...
namespace App2.weixinInit
{
    ...
    class wxInit
    {
        public static Init Get_Init(string json)
        {
            var init = Init.FromJson(json);
            return init;
        }
    ...
    public partial class Init
    {
        public static Init FromJson(string json) => JsonConvert.DeserializeObject<Init>(json, App2.weixinInit.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Init self) => JsonConvert.SerializeObject(self, App2.weixinInit.Converter.Settings);
    }
