...
namespace App2.weixinContact
{
    class wxContact
    {
        public static Contact Get_Contact(string json)
        {
            var init = Contact.FromJson(json);
            return init;
        }
    ...
    public partial class Contact
    {
        public static Contact FromJson(string json) => JsonConvert.DeserializeObject<Contact>(json, App2.weixinContact.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Contact self) => JsonConvert.SerializeObject(self, App2.weixinContact.Converter.Settings);
    }
